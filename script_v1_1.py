...
stats = {enseigne: {"tentees": 0, "reussies": 0} for enseigne in enseignes}  # pour avoir le ratio de pages scrapées réussies/tentées 
    ...
    try:
        for enseigne, url in zip(enseignes, trustpilot):
            ...
            while True:
                ...
                stats[enseigne]["tentees"] += 1  # NEW : une page chargée = une tentative
            ...
            # NEW : taux de succès pour cette enseigne
